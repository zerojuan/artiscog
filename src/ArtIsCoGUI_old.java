...
//    			int randEdge = rand.nextInt(theGraph.getSize());
				int randEdge= constantGraph[randNumEdge];
...
//     	}
     	...
     	//for(int i=0; i<10; i++){
     		ImmuneAlgo clonalG = new ImmuneAlgo(this, adjList, antibodyN, selectionPoolN, generationsN, k, remainderN, clonalFactor);
     	//}
     }
     
     public void upDate(String antibody, int generationsN, int constrained, int k)
     {
